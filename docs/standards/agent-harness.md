...
it changes is the trigger, not the rule. The reasoning is in
[0007. Give each documentation rule one checker](../architecture/adr/0007-give-each-documentation-rule-one-checker.md).
